...
def parse_option(print_option=True):    
    ...
    # Data Directory
    p.add_argument('--data_root', default= r'C:\Users\NM_RR\Desktop\SJ\data\SPECT_data\rest\ac\*', type=str, help='root directory of dataset files.')
    ...
    # Hyper-parameter
    p.add_argument('--batch_size', default=10, type=int, help='use 1 batch size in 3D training.')
    ...
    # Output directory
    p.add_argument('--exp', default='C:/Users/NM_RR/Desktop/SJ/U-Net/output/rest_dicom/sh/', type=str, help='checkpoint dir.')
    p.add_argument('--save_dir', default='plots_prob', type=str, help='evaluation plot directory')
    
    p.add_argument('--patch', default='False', type=str2bool, help='patch analysis?')
