...
def create_model(opt):
    ...
    if opt.resume:
        if os.path.isfile(r'C:\Users\NM_RR\Desktop\SJ\U-Net\output\rest_dicom\epoch_0150_loss_0.00950991.pth'):
            pretrained_dict = torch.load(r'C:\Users\NM_RR\Desktop\SJ\U-Net\output\rest_dicom\epoch_0150_loss_0.00950991.pth', map_location=torch.device('cuda'))
